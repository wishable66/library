...
const form = document.querySelector('form#addnewbook');
...
form.addEventListener('submit', (e) => {
    ...
    const bookCoverPage = form.querySelector('input[name="cover"]').value;
    const bookAuthor = form.querySelector('input[name="author"]').value;
    const bookPages = form.querySelector('input[name="pages"]').value;
    const bookHasRead = form.querySelector('input[name="hasread"]').value;
    // if (bookHasRead === '1') {
    //   addBookToLibrary(
